  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.roleBadgeRow}><View style={styles.roleBadge}><Text style={styles.roleText}>Super Admin</Text></View></View>
        <View style={styles.section}>
          <View style={styles.detailCard}>
            {[{ icon: 'shield', label: 'Role', value: 'Administrator' }, { icon: 'business', label: 'Org', value: 'Sleepy Classes IAS' }].map((item, idx) => (
        ...
        <View style={styles.section}>
          <TouchableOpacity testID="admin-logout-button" style={styles.logoutBtn} onPress={confirmLogout}><Ionicons name="log-out-outline" size={20} color={theme.colors.danger} /><Text style={styles.logoutText}>Logout</Text></TouchableOpacity>
        </View>
...
const styles = StyleSheet.create({
  ...
  roleBadge: { paddingHorizontal: 14, paddingVertical: 4, borderRadius: 20, backgroundColor: theme.colors.primaryDark + '20' },
